...
if 'c_dim_t_forced' in globals():
    ...
    # FIXME c_dim_t_forced is undefined
...
try:
    # FIXME consider using the Enum or custom clas. No need in this check.
...
def get_complex_number(real, imag):
    return real.value if not imag.value else real.value + imag.value * 1j
